...
RUN cd home/MetaXcan/software/data && wget https://zenodo.org/record/3519321/files/gtex_v8_expression_elastic_net_snp_smultixcan_covariance.txt.gz
RUN cd home/MetaXcan/software/data && wget https://zenodo.org/record/3519321/files/elastic_net_eqtl.tar
...
RUN cd home/H-MAGMA/Codes && wget https://ctg.cncr.nl/software/MAGMA/prog/magma_v1.09a.zip && unzip magma_v1.09a.zip
